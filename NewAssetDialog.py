...
class NewAssetDialog(object):
    def __init__(self, parent, dict_key = None):
        ...
        rb_category1.grid(row = 4, column = 0, sticky = W)
        ...
        rb_category2.grid(row = 4, column = 1, sticky = W)
        ...
        rb_category3.grid(row = 5, column = 0, sticky = W)
        ...
        rb_category4.grid(row = 5, column = 1, sticky = W)
        ...
        self.name_entry.grid(row = 6, column = 1, sticky = W)
        ...
        submit_button.grid(row = 7, column = 0, sticky = W, pady = (10, 0))
        ...
        cancel_button.grid(row = 7, column = 1, sticky = E, pady = (10, 0))
