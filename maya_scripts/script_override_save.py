...
if "edits" in directory:
    ...
    cmds.playblast(frame = current_frame, format = "image", cf = directory + "/../../images/screenshots/" + file_name + ".gif", v = False, wh = (498, 270), p = 100, orn = False, os = True)
    cmds.playblast(frame = current_frame, format = "image", cf = directory + "/../../images/screenshots/" + file_name + "small.gif", v = False, wh = (249, 135), p = 100, orn = False, os = True)
else:
    if not path.isdir(directory + "/../images/screenshots"):
        mkdir(directory + "/../images/screenshots")
    cmds.playblast(frame = current_frame, format = "image", cf = directory + "/../images/screenshots/" + file_name + ".gif", v = False, wh = (498, 270), p = 100, orn = False, os = True)
    cmds.playblast(frame = current_frame, format = "image", cf = directory + "/../images/screenshots/" + file_name + "_small.gif", v = False, wh = (249, 135), p = 100, orn = False, os = True)
